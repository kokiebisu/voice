...
console.log(isEmail("YTVHJJK123@ll.jj.ca"))
console.log(isEmail("YTVdddJJK123@lljj..ca"))
console.log(isValid('Paow(23dH'))
console.log(isValid('P1s'))
console.log(isSchool("@bcit.ca"))
console.log(isSchool("@bcct.ca"))
